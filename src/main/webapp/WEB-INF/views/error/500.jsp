            ...
            <div class="col-lg-7">
                <div class="card error-card">
                    <div class="card-body p-5 text-center">
                        ...
                        <h2 class="h4 fw-bold mb-3">Ocurrió un problema inesperado</h2>
                        <p class="text-secondary mb-4">${not empty mensaje ? mensaje : 'Estamos trabajando para solucionarlo. Intenta nuevamente en unos minutos.'}</p>
